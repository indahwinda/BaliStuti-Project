            ...
            <form action="{{url ('insert-product')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('small_description') is-invalid @enderror" name="small_description" value="{{old('small_description')}}">
                    @error('slug')
                    <div class="text-danger">
                        {{$message}}
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="dengan-rupiah" class="form-control @error('original_price') is-invalid @enderror" name="original_price" value="{{old('original_price')}}">
                    @error('slug')
                    <div class="text-danger">
                        {{$message}}
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="dengan-rupiah2" class="form-control @error('selling_price') is-invalid @enderror" name="selling_price" value="{{old('selling_price')}}">
                    @error('selling_price')
                    <div class="text-danger">
                        {{$message}}
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('qty') is-invalid @enderror" name="qty" value="{{old('qty')}}">
                        @error('qty')
                        <div class="text-danger">
                            {{$message}}
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('tax') is-invalid @enderror" name="tax" value="{{old('tax')}}">
                    @error('tax')
                    <div class="text-danger">
                        {{$message}}
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea rows="3" type="text" class="form-control @error('meta_keywords') is-invalid @enderror" name="meta_keywords" >{{old('meta_keywords')}}</textarea>
                    @error('meta_keywords')
                    <div class="text-danger">
                        {{$message}}
                    </div>
                    ...
                    <div class="col-md-12  mb-3">
                        ...
                        <textarea rows="3" type="text" class="form-control @error('meta_description') is-invalid @enderror" name="meta_description" >{{old('meta_description')}}</textarea>
